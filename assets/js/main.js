...
function playerSphereCollision(
    sphere
) {
...
/*
    collision-world.glb está dentro de:
...
loader.load(
    ...
    (gltf) => {
        ...
        /*
            Crear estructura de colisiones
    ...
    (xhr) => {
        ...
        if (
            ...
            console.log(
                `Cargando escenario: ${progreso.toFixed(0)}%`
            );
